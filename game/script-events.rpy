...
label event_sanjo:
    ...
    n 1tlraj "So...{w=1}{nw}"
    extend 1tnmbo " I guess we kinda just took to having him around,{w=0.2} I guess."
    n 1cslfl "...Still doesn't explain why someone just decided to shove him underneath the teacher's desk though.{w=0.75}{nw}"
    extend 1fslem " Jerks."
    n 1ccsfl "Well,{w=0.2} anyway -{w=0.5}{nw}"
    extend 1ulrfl " he's been left around long enough,{w=0.5}{nw}"
    extend 1fcstr " so clearly {i}someone{/i} is gonna have to take care of Sanjo here."
    n 1fchgn "...And who better to step up to the plate than yours truly!"
    n 1fsqsm "Ehehe.{w=0.75}{nw}"
    extend 1fcsbg " Yep!"
    n 1fcsbs "I think it's about time [n_name] finally got her green thumb going!"
    n 1clrbgsbl "Don't get me wrong -{w=0.5}{nw}"
    extend 1csrsssbl " I'm not saying I'm gonna be some professional gardener or anything like that.{w=0.75}{nw}"
    extend 1fcsss " But let's face it."
    n 1ullaj "If you're gonna take up a little horticulture..."
    n 1fchbg "Where better to start than a cactus,{w=0.2} right?"
    n 1tlrss "Think about it,{w=0.2} [player] -{w=0.5}{nw}" 
    extend 1fdlsm " this little guy was practically {i}made{/i} for a beginner.{w=0.75}{nw}"
    extend 1fcsbg " He basically already fends for himself!"
    ...
    extend 1fcsbg " how hard could it {i}possibly{/i} be?"
    n 1fcssmesm "Ehehe."
    n 1fcsaj "So!"
    n 1flrss "You better keep your eyes and ears{w=0.5}{nw}" 
    extend 1fsqss " {i}pricked{/i},{w=0.75}{nw}" 
    extend 1fsqbg " [player]..."
    n 1nchgnl "'Cause I'm gonna get Sanjo here blooming before you know it!"
