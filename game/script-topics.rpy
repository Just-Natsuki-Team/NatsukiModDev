...
label talk_windup_bullying:
    ...
    n 1fllbg "I...{w=0.5} was just thinking out loud again."
    ...
    n 1fsqsr "Bullies."
    n 1fcsem "And no,{w=0.75}{nw}" 
    extend 1fsqpu " I'm not joking around.{w=1}{nw}"
    extend 1fllwr " I can't think of {i}anything{/i} I hate more!"
    ...
    n 1fsqem "And I don't just mean physically,{w=0.1} either!"
    ...
    n 1fsrss "A school bully doesn't exactly have a manager you can report them to..."
    n 1fchgnelg "...And work is the {i}last{/i} place for a brawl!{w=0.75}{nw}"
    extend 1fslpol " As boring as {i}that{/i} is."
    n 1nllaj "So...{w=0.5}{nw}"
    extend 1fsrpol " stick up for yourself,{w=0.1} got it?"
    n 1fllss "You just gotta make sure you use your brain and pick your battles when you do!{w=1}{nw}"
    extend 1fchgn " That's all I'm saying!"
    n 1fsqss "And besides..."
    ...
    if Natsuki.isEnamored(higher=True):
        ...
        n 1fsrpol "You owe yourself that much,{w=0.1} at least."
