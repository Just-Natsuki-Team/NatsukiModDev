...
label talk_rage_rooms:
    ...
    n 1uchgnelg "...You get to beat the absolute {i}snot{/i} out of all of everything!"
    ...
    extend 1ullbo " they already supply a bunch of their own things you can smash up...{w=0.75}{nw}"
    ...
    extend 1nsrsssbl " no big batteries or anything dumb like that."
    n 1fsqsm "Finally had enough of that garbage printer chewing up all your assignments?"
    n 1fcsbg "...Trial by combat it is!"
    n 1unmajesu "Oh!{w=0.5}{nw}"
    ...
    n 1fsqbg "If that isn't a {w=0.2}{i}smashing{/i}{w=0.2} way to relieve stress..."
    n 1uchgn "I don't know what is!{w=0.5}{nw}"
    extend 1fchsmeme " Ehehe."
