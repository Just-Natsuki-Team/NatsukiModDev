...
label talk_service_animals:
    if get_topic("talk_service_animals").shown_count > 0:
        ...
        if Natsuki.isNormal(higher=True):
            ...
            n 4ccsgs "And oh.{w=0.5}{nw}"
            extend 2ccsfl " My.{w=0.5}{nw}"
            extend 2csqaj " God.{w=0.5}{nw}"
            ...
            extend 2clrsl " most of them were just a {i}total{/i} snooze-fest."
    ...
    if Natsuki.isNormal(higher=True):
        ...
        extend 2unmbo " But there's actually a {i}ton{/i} of roles people never even think about.{w=0.75}{nw}"
        n 4unmaj "Seriously!"
        n 4ulrss "There's ones that are meant to help more with mobility,{w=0.5}{nw}"
        extend 3cllsssbr " some that listen out for stuff if their owner has sucky hearing..."
        n 3unmbg "Even helping out with managing medical conditions or avoiding allergies!{w=0.75}{nw}"
        ...
        extend 4unmbo " but they're sorta like extra-tame pets for people going through some kind of rough time."
        n 2ullaj "You know,{w=0.5}{nw}" 
        extend 2unmss " like emotionally or mentally."
        n 4nchgn "...And they come in a whole load of shapes and sizes too!"
        ...
        n 6fcsbg "You won't only find them hanging around the home either,{w=0.2} [player] -{w=0.5}{nw}"
        extend 6unmbg " offices,{w=0.2} hospices and even hospitals can arrange visits too!"
        
        if Natsuki.isAffectionate(higher=True):
            n 3nchgn "Awesome,{w=0.2} right?{w=0.75}{nw}"
            extend 3clrss " Ehehe..."
            n 4clrslsbl "..."
            n 5ksrbosbl "..."
            n 1kcsflesi "..."
            n 1kllbo "...It just sucks sometimes,{w=0.2} thinking about it now.{w=0.75}{nw}"
            ...
            extend 2klrbolsbl " I doubt it takes a genius to work out why."
            ...
            if Natsuki.isEnamored(higher=True):
                ...
                n 4ccsemlsbr "I...{w=0.5} know...{w=0.75}{nw}" 
                extend 4cdlfllsbr " they can't work miracles.{w=0.75}{nw}"
                extend 2ccspolsbr " I-{w=0.2}I'm not naive."
                n 4kslpulsbr "But..."
                n 4kslfllsbr "It would have been something...{w=1}{nw}"
                extend 5knmbolsbr " right?"
                n 5ksrbolsbr "...I just can't shake the feeling that maybe just that one thing was all she needed."
                n 1ksrcalsbl "..."
                n 4ccsfllsbl "...A-{w=0.2}anyway."
        ...
        n 3ulrbo "It wasn't a super long visit or anything,{w=0.5}{nw}"
        extend 3csrss " so the volunteers didn't stick around for {i}that{/i} long...{w=1}{nw}"
        extend 4uchgn " but they did let us go up and meet the animals they brought in with them!"
        n 3fcssmesm "No surprises who got picked to go up first,{w=0.2} huh?{w=0.75}{nw}"
        extend 3fsqsm " Ehehe."
        n 4fcsbg "Yep!"
        n 2ullbg "When it comes to those kinds of animals,{w=0.2} it's gotta be said.{w=0.75}{nw}"
        extend 6fchbg " Nothing beats a real hands-on experience!"
        n 2fchsm "Ahaha.{w=0.75}{nw}"
        extend 2tllss " Well,{w=0.2} anyway."
        n 4ullaj "I think I've gone on for way too long already,{w=0.5}{nw}"
        extend 6fcssmesm " but I hope you learned something too,{w=0.2} [player]!{w=0.75}{nw}"
        extend 3fsqbg " And if not?"
        ...
        extend 2fcsca " But people forget just how adaptable they are too."
        ...
        n 7clrfl "I guess they're kinda like super-tame pets people have to help them get through a rough time.{w=0.75}{nw}"
        extend 2fcssl " Heh.{w=0.75}{nw}"
        ...
        n 1ulrfl "You can even get visits arranged to hospitals and hospices now,{w=0.2} so...{w=1}{nw}"
        extend 2cdrbo " yeah.{w=0.75}{nw}"
