...
label talk_rage_rooms:
    ...
    if already_discussed_rage_rooms:
        ...
        n  "I know we spoke about them before,{w=0.2} but..."
        n  "Well,{w=0.75}{nw}"
        extend  " can you blame me?"

    else:
        n  "Hey,{w=0.2} [player]..."
        n  "This is kinda random,{w=0.5}{nw}"
        extend  " but..." 
        n  "Have you ever been to a rage room before?"
        n  "I've never actually {i}been{/i} to one myself,{w=0.75}{nw}"
        extend  " but oh.{w=0.5}{nw}"
        extend  " My.{w=0.5}{nw}"
        extend  " God.{w=0.5}{nw}"
        extend  " [player]."

    n  "They...{w=0.75}{nw}" 
    extend  " look...{w=0.75}{nw}"
    extend  " {i}awesome{/i}!"
    n  "No,{w=0.2} really!{w=0.75}{nw}"
    extend  " I'm serious!"
    n  "You basically get an entire room full of useless old junk:{w=0.5}{nw}"
    extend  " unwanted furniture,{w=0.2} decorations,{w=0.2} old computer hardware...{w=0.75}{nw}"
    extend  " as well as a bunch of tools and safety equipment."
    n  "You know.{w=0.75}{nw}"
    extend  " Goggles,{w=0.2} hammers,{w=0.5}{nw}"
    ...
    n  "...And the best part?{w=1}{nw}"
    extend  " You don't have to clean up afterwards either!{w=0.75}{nw}"
    ...
    n  "Of course,{w=0.5}{nw}" 
    extend  " they already supply a bunch of their own things you can smash up...{w=0.75}{nw}"
    n  "But you can totally bring your own stuff too!{w=0.75}{nw}"
    extend  " Well..."
    n  "So long as it's all safe to break up -{w=0.5}{nw}"
    ...
    n  "...Trial by combat it is!"
    n  "Oh!{w=0.5}{nw}"
    extend  " Don't get me wrong though."
    n  "You still gotta pay regardless of if you brought your own junk,{w=0.75}{nw}"
    extend  " of course...{w=1}{nw}"
    extend  " and it really {i}isn't{/i} a way to deal with anger issues or anything like that."
    n  "But I gotta say,{w=0.2} [player]."
    n  "If that isn't a {i}smashing{/i} way to relieve stress..."
    n  "I don't know what is!{w=0.5}{nw}"
    extend  " Ehehe."
