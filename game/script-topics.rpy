...
label talk_feelings_about_sayori:
    ...
    n "..."
    n "I...{w=0.5}{nw}"
    extend " still get mad at myself sometimes,{w=0.1} you know."
    n "I just can't {i}believe{/i} how I wrote off how she was feeling so easily."
    n "...And how I forgot she even {i}existed{/i}."
    n "If I'd have just {i}known{/i} how bad her mental health was...{w=1}{nw}"
    extend " how much she was {i}hurting{/i}..."
    n "..."
    n "It's...{w=1.5}{nw}" 
    extend " it's still just such a system shock,{w=0.1} you know?"
    n "She was always so...{w=0.3} so...{w=0.5}{nw}"
    extend " just...{w=0.3} super excited and clingy!"
    n "Like she was just {i}vibrating{/i} with happiness!"
    n "..."
    n "...So can you even {i}imagine{/i} how it feels?"
    n "Knowing she was just wearing a mask,{w=1}{nw}"
    extend " then dancing like a puppet under Monika's hand?"
    n "...While her own mind was beating the absolute {i}crap{/i} out of her."
    n "..."
    n "Heh.{w=1}{nw}"
    extend " You know what?"
    n "I don't care about my cookie she took a giant bite out of."
    n "I don't care about the dumb songs she'd sing,{w=1}{nw}"
    extend " or her...{w=0.3} awkward...{w=0.3} compliments."
    n "At this point?"
    n "I think I'd do {i}anything{/i} just to see a genuine Sayori smile again..."
    n "...And give her one of those big,{w=0.1} dumb hugs she liked so much."
