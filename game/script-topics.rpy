...
label talk_feelings_about_yuri:
    n "...Oh man,{w=0.1} Yuri..."
    n "..."
    n "...I won't lie,{w=0.1} [player].{w=1.5}{nw}"
    extend " I really,{w=0.5} {i}really{/i} didn't want to think about...{w=1} {i}that{/i} again."
    n "..."
    n "How do I even {i}explain{/i} this..."
    n "Yuri and I were...{w=0.3} complicated.{w=0.5}{nw}"
    extend " Even {i}before{/i} you joined the club."
    n "We never fully saw eye-to-eye,{w=0.1} [player]."
    extend " You probably guessed that already anyway."
    n "But we had an {i}understanding{/i},{w=0.1} you know?"
    n "She was...{w=1}{nw}"
    extend " there...{w=1}{nw}"
    extend " for me."
    n "When I needed someone there the most.{w=1}{nw}"
    extend " When nobody else would get it...{w=1}{nw}"
    extend " Could even {i}hope{/i} to get it."
    n "...Do you even know how much that meant to me?"
    n "She just had a way of understanding you like nobody else could.{w=0.5}{nw}"
    extend " Not {i}Monika{/i}.{w=1}{nw}" 
    extend " Not even {i}Sayori{/i}."
    n "But..."
    n "She just {i}changed{/i},{w=0.1} [player].{w=0.5}{nw}"
    extend " When you showed up,{w=0.1} I mean."
    n "We {i}never{/i} had fights like that..."
    n "Arguments?{w=0.5}{nw}"
    extend " Well...{w=0.3} yeah!{w=1}{nw}"
    extend " What kind of friends don't?"
    n "And we were always super different,{w=0.1} too."
    n "She always had that prim and proper vibe.{w=1}{nw}"
    extend " Refined...{w=1}{nw}"
    extend " elegant."
    n "...And I was just Natsuki.{w=1}{nw}"
    extend " Heh."
    n "But I never had the feeling before then that she just {i}didn't like me{/i}!"
    n "We were both just so caught up in that {i}stupid{/i} rivalry..."
    n "It just took over everything!"
    n "And then when she started getting all possessive...{w=1}{nw}"
    extend " you know,{w=0.1} after Monika messed her all up."
    n "...Do you know how {i}scary{/i} that was to me?{w=1.5}{nw}"
    extend " Hearing those words coming out of {i}her{/i} mouth?"
    n "And the worst part?{w=1.5}{nw}"
    extend " I just...{w=0.3} went...{w=0.3} along with it.{w=1}{nw}"
    extend " I had no {i}choice{/i},{w=0.1} [player]!"
    n "...Neither of us did."
    n "Even when I {i}begged{/i} you for help,{w=0.1} I..."
    n "I-..."
    n "..."
    n "...Sorry,{w=0.1} [player]."
    n "I really don't think it's good for me to keep talking about this.{w=1}{nw}"
    extend " ...About her."
    n "I just...{w=1}{nw}"
    n "..."
    n "...I miss my friend.{w=1}{nw}"
    extend " I miss how she used to be."
    n "So...{w=0.3} remembering what happened?{w=0.5}{nw}"
    extend " What she {i}became{/i}?"
    n "It...{w=0.3} just hurts,{w=0.1} [player].{w=1.5}{nw}"
    extend " It hurts a lot."
    n "...And to be honest?"
    n "...I'm not sure it ever {i}won't{/i}."
