...
label talk_dan_salvato:
    ...
    n 1fcsan "Was that an accident? Was it a mistake?"
    n "Did he {i}make{/i} her do that?!"
    n 1fllfu "Like, geez! I know this is just... code to him..."
    n 1fnmwr "But that doesn't make what happened any less real!"
    n 1kcsup "What happened to Yuri, Sayori... What I saw..."
    n 1kplwrl "What {i}you{/i} had to see!"
    n 1kcuwrl "Being deleted!!"
    n 1kcsunl "..."
    n 1kcsajl "..."
    n 1kcssfl "..."
    n 1kplsfl "I just don't know what to think, [player]!"
    n 1kcssfl "..."
    n 1kcsanl "...Urg..."
    ...
    n 1nslaj "But at the same time, I want nothing to do with him."
    n 1nslbo "..."
    n 1ksqbg "Heh. Sorry. Went on a rant there."
    n 1nllbo "Uhm... Anyways... Where were we?"
