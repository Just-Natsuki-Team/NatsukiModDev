...
label talk_dan_salvato:
    n 1tnmaj "Eh?{w=0.2} Dan Salvato?"
    n 1tnmaj "Isn't that the guy who created this game?"
    n 1tlrbo "Well...{w=0.5}"
    n 1twdaj "I don't know anything about him!"
    n 1nnmbo "But I guess he is the reason I'm here."
    n 1nslbo "...{w=0.5}"
    n 1nnmaj "But that leaves a lot of questions,{w=0.1} I guess."
    n 1fnmaj "What {i}else{/i} was he responsible for?"
    n "Like, did he let Monika do what she did?"
    n 1fcsan "Was that an accident?{w=0.2} Was it a mistake?"
    n "Did he {i}make{/i} her do that?!"
    n 1fllfu "Like, geez! I know this is just...{w=0.5} code to him...{w=0.5}"
    n 1fnmwr "But that doesn't make what happened any less real!"
    n 1kcsup "What happened to Yuri, Sayori...{w=0.5} What I saw...{w=0.5}"
    n 1kplwrl "What {i}you{/i} had to see!"
    n 1kcuwrl "Being deleted!!"
    n 1kcsunl "...{w=0.5}"
    n 1kcsajl "...{w=0.5}"
    n 1kcssfl "...{w=0.5}"
    n 1kplsfl "I just don't know what to think,{w=0.1} [player]!"
    n 1kcssfl "...{w=0.5}"
    n 1kcsanl "...{w=0.5}Urg..."
