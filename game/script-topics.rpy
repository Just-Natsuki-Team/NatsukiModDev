    ...
    if Natsuki.isEnamored(higher=True):
        if already_unlocked_cosplay_outfits:
            ...
            if Natsuki.isWearingClothes("jn_clothes_trainer_cosplay") or Natsuki.isWearingClothes("jn_clothes_sango_cosplay"):
                ...
                n 1fcseml "I'm not your own personal dress-{w=0.2}up doll,{w=0.75}{nw}"
            ...
            extend 1fcssmeme " Any excuse to break out my sewing kit and show off my style {i}and{/i} needlework."
