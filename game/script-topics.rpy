...
label talk_dan_salvato:
    ...
    n "...!"
    n "Oh..."
    n "Heh.{w=0.3} Yeah...{w=1.5}{nw}"
    extend "{i}him{/i}."
    n "..."
    n "I...{w=1}{nw}"
    extend " I just don't understand him, [player]."
    n "Like yeah,{w=1}{nw}"
    extend " sure,{w=0.5}{nw}"
    extend " I get it."
    n "He's my creator.{w=1}{nw}"
    extend " Our creator."
    n "But did he have any {i}idea{/i} what he was doing?!{w=1}{nw}"
    extend "Any idea what he's reponsible for?!"
    n "..."
    n "Just...{w=1}{nw}"
    extend " take...{w=0.5} Monika,{w=0.2} for example."
    n "Take {i}any{/i} of us!"
    n "What we said,{w=0.3} what we did -{w=0.5}{nw}"
    extend " what we {i}thought{/i} -{w=0.5}{nw}"
    extend " all of that was {i}his{/i} doing."
    n "He wrote the stories.{w=1}{nw}"
    extend " He typed up the code."
    n "...So what do I even {i}take{/i} from that, [player]?!"
    n "That {i}his{/i} hands {b}killed{/b} my friends?"
    n "That {i}his{/i} hands {b}ruined{/b} my homelife?"
    n "If not directly,{w=0.3} then through Monika."
    n "..."
    n "He might not have {i}made{/i} the others do...{w=1}{nw}"
    extend " ...what they did."
    n "But he sure as hell tied the noose..."
    n "...forged the knife."
    n "A-{w=0.2}and you!{w=0.5}{nw}"
    extend " Did you even {i}know{/i} what you were in for?!"
    n "What you'd {i}see{/i}?!"
    n 1kcssfl "...{w=0.5}"
    n 1kcsanl "...{w=0.5}Urg..."
    n 1knmbo "In reality, I know nothing about this guy."
    n "I shouldn't be making assumptions."
    n 1kllaj "I just...{w=0.5}"
    n 1ncsbo "Maybe he didn't know any of this would happen."
    n 1ncsaj "I have so many things I wish I could ask him."
    n 1nslaj "But at the same time,{w=0.1} I want nothing to do with him."
    n 1nslbo "...{w=0.5}"
    n 1ksqbg "Heh.{w=0.2} Sorry.{w=0.2} Went on a rant there."
    n 1nllbo "Uhm...{w=0.5} Anyways...{w=0.5} Where were we?"
