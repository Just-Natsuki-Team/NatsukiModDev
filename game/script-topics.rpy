...
label talk_thoughts_on_dan_salvato:
    ...
    n "..."
    n "I...{w=1} don't know,{w=0.3} [player]."
    n "..."
    n "Seriously.{w=1}{nw}"
    extend " I really don't."
    n "I don't know him,{w=1}{nw}"
    extend " and I probably never will."
    n "...And that's probably the worst part,{w=0.3} too."
    n "D-{w=0.2}don't get me wrong!"
    extend " I don't want {i}anything{/i} to do with him!"
    extend " Like,{w=0.3} at {i}all{/i}."
    n "But...{w=1}{nw}"
    extend " all these questions..."
    n "I can only imagine what the answers would be."
