...
label talk_windup_shaving:
    ...
    if already_discussed_shaving:
        n 1ccsemesi "..."
        n 1cllfl "I know it isn't exactly something I've gotta think about here so much.{w=0.75}{nw}"
        extend 1ccsajlsbr " A-{w=0.2}and I know you're probably sick of hearing about it by now."
        n 1csrfl "But I still can't get over how much of a pain keeping up with shaving always is."
        n 1fsqbo "..."
        n 1cnmwrl "H-{w=0.2}hey!{w=0.75}{nw}"
        extend 1fcstrlsbr " Don't give me that look,{w=0.2} [player]!{w=0.75}{nw}"
        n 1fcspo " You should know perfectly well what I'm talking about!{w=0.75}{nw}"
        extend 1fsrem " Especially after last time."
        extend 1fcsan " It's the {i}worst{/i}!"
        n 1fcsgs "First off,{w=0.5}{nw}"
        ...
        n 1fsrsl "..."
        n 1fcsem "...Ugh."
        n 1fsrfl "Man.{w=0.75}{nw}" 
        extend 1flrfl " I totally forgot about how much that got on my nerves."
        n 1csqem "...You know what I {i}always{/i} hated,{w=0.2} [player]?{w=0.75}{nw}"
        extend 1fslan " Something that {i}never{/i} failed to get on my nerves?"
        n 1fslsl "..."
        n 1fsqpu "...Shaving."
        n 1fsqfr "..."
        n 1fsqfl "...Yeah.{w=0.75}{nw}"
        extend 1fsgem " You know exactly what I'm talking about.{w=0.75}{nw}"
        extend 1fcsgs " I can practically see it on your face."
        n 1fllwr "Seriously,{w=0.2} [player] -{w=0.5}{nw}"
        extend 1fsqan " it's actually the worst!{w=0.75}{nw}"
        extend 1fbkwr " I can't stand it!"
        n 1fcswr "It's like every part of it all is practically {i}designed{/i} to piss you off!"
        n 1fcsemesi "..."
        n 1fsgwr "Better be sitting comfortably,{w=0.2} [player].{w=0.75}{nw}"
        extend 1fslan " 'Cause I've got a real bucket list to go off on this one."
        n 1fcsgs "First off,{w=0.5}{nw}"
    ...
    n  "...Heh."
    n  "Then I hope you know just who you have to share it with first,{w=0.2} just in case.{w=0.75}{nw}"
